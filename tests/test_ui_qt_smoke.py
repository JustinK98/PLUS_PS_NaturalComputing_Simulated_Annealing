...
class QtSmokeTests(unittest.TestCase):
    ...
    def test_activation_workflow_online_sa_smoke(self) -> None:
        ...
        self.assertTrue(workspace.candidate_epochs_spin.isHidden())
        workspace.sa_mode_combo.setCurrentText("short_retrain")
        self.assertFalse(workspace.candidate_epochs_spin.isHidden())
    ...
    def test_builder_workspace_loads_saved_results(self) -> None:
        ...
        self.assertTrue(workspace.candidate_epochs_spin.isHidden())
        self.assertTrue(workspace.objective_combo.isHidden())
        self.assertFalse(workspace.online_train_policy_combo.isHidden())
