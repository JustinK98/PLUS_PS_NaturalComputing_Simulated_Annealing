        ...
        entries = [
            _TimelineEntry(
                ...
                details=(
                    ...
                    f"Start-Validation-Loss (Diagnose): {start.val_loss:.6f}",
            ...
            entries.append(
                _TimelineEntry(
                    ...
                    details=(
                        ...
                        f"Gewichtsupdate ausgeführt: {step.trained_after_accept}",
                        f"Trainierte Mini-Batches: {step.trained_batch_updates_after_step}",
                        f"Effektive Online-Epochen: {step.effective_online_epochs_after_step:.3f}",
                        f"Validation-Loss (Diagnose): {step.validation_loss_after_update:.6f}",
